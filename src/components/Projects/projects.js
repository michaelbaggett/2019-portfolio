    ...
    <div className="container" id="projects">
      <div className="row">
        <div className="col" id="proj">
          ...
          <p>
            In Development. Zoopocalypse aims to reinforce the correct spelling
            of zoo animal names. Spelling an animal name correctly, in order,
            releases the animal from its cage. As the player levels up, the
            animal names grow more challenging.{" "}
          </p>
        ...
        <div className="col" id="proj2">
          ...
          <p>
            A simple take on a standard listening exercise from music school.
            Listen to context clues from the composition playing and see if you
            can guess the composer's name.{" "}
          </p>
